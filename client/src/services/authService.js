...
const API_URL =
  ...
  "https://digital-mental-health-and-psycholog.vercel.app/api";
...
// ✅ NEW: Counselor registration
export const registerCounselor = (userData) => {
  return api.post("/auth/registerCounselor", userData);
};
